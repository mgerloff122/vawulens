    ...
    <section className='contact'>
      <div className="container contact__container">
        <div className="contact__wrapper">
          <a href="mailto:gerloffmp@vcu.edu" target="_blank" rel='noreferrer noopener'><MdEmail /></a>
          <a href="http://m.me/ernest_achiever" target="_blank" rel='noreferrer noopener'><BsMessenger /></a>
          <a href="https://wa.me/+4344304876" target="_blank" rel='noreferrer noopener'><IoLogoWhatsapp /></a>
        </div>
      </div>
    </section>
    </>
